...
{
    /// <inheritdoc />
    public partial class addmigrationUserReliantTablesCreated : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViewedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PropertyViews_Leads_LeadId",
                        column: x => x.LeadId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyViews_ViewedOn",
                table: "PropertyViews",
                column: "ViewedOn");
